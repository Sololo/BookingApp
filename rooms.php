            ...
            <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 px-lg-0">
                <nav class="navbar navbar-expand-lg bg-white rounded shadow">
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <button class="navbar-toggler shadow" type="button" data-bs-toggle="collapse" data-bs-target="#filterDropdown" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <label for="form-label">Check-ouy</label>
                                <input type="date" class="form-control shadow-none">
                            </div>
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" style="font-size: 18px;">FACILITIES</h5>
                                <div class="mb-2">
                                    <input type="checckbox" id="f1" class="form-check-input shadow-none me-1">
                                    <label for="form-check-label" for="f1">Facility one</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checckbox" id="f2" class="form-check-input shadow-none me-1">
                                    <label for="form-check-label" for="f2">Facility two</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checckbox" id="f3" class="form-check-input shadow-none me-1">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        <label for="form-label">Adult</label>
